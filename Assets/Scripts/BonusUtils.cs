...
public static class BonusUtils
{
    ...
    static int[] addValues = { 10, 15, 20, 25, 30, 35, 40, 45, 50 };
    static int[] multiplyValues = { 2, 3, 4, 5 };
    ...
    public static int GetRunnersAmountToAdd(int currentRunnersAmount, Bonus bonus)
    {
        switch (bonus.GetBonusType())
        {
            ...
            case BonusType.Multiply:
                Debug.Log("Runners Amount to Add = " + ((currentRunnersAmount * bonus.GetValue()) - currentRunnersAmount));
